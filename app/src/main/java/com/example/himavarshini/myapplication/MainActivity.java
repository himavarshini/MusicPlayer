...
package com.example.himavarshini.myapplication;
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (temp + forwardTime < finalTime) {
                    ...
                    Toast.makeText(getApplicationContext(), "Seeking 5 sec Forward", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getApplicationContext(), "Seeking not allowed", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((temp - backwardTime) > 0) {
                    ...
                    mediaPlayer.seekTo((int) startTime);
                    Toast.makeText(getApplicationContext(), "Seeking 5 sec Backward", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getApplicationContext(), "Seeking not allowed", Toast.LENGTH_SHORT).show();
